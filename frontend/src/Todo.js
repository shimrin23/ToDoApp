    ...
    <div className="container-fluid text-center ">
      <>
        ...
        <div className="row mt-3 justify-content-center">
          ...
          <div className="form-group d-flex flex-wrap gap-2 justify-content-center col-md-8">
            <input
              placeholder="Title"
          ...
          <div className="container text-center col-md-6">
            <ul className="list-group">
              {todos.map((item) => (
                <li
                  key={item._id}
                  className="list-group-item bg-info d-flex justify-content-between align-items-center my-2 flex-wrap"
                >
